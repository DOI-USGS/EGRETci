...
4)  Create prediction intervals around estimated concentration or flux values for specific days, months, or years.  The estimates of interest here are the [WRTDS_K](http://doi-usgs.github.io/EGRETci/).  A detailed description of how these estimates can be made is provided in the vignette on [WRTDS Kalman Prediction Intervals](https://usgs-r.github.io/EGRETci/articles/prediction.html).
