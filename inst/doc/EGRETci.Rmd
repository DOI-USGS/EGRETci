...
The package **EGRETci** encompasses the various approaches to uncertainty estimation associated with WRTDS trend analysis implemented in the **EGRET** package.  The various functions included here are all discussed in a manuscript _A bootstrap method for estimating uncertainty of water quality trends_ by Hirsch, Archfield, and De Cicco (the manuscript is currently accepted to Environmental Modelling & Software and will be publicly available soon, email rhirsch@usgs.gov for access in the interim).  
